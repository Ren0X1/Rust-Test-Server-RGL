...
{
    [Info("Building Skins", "Marat", "2.0.12")]
            ...
            config = new PluginConfig
            {
                ...
                BuildingImages = new Dictionary<int, List<BlockInfo>>
                {
                    ...
                    [1] = new List<BlockInfo>
                    {
                        ...
                        new("Crypt", "https://i.ibb.co/jPw0YQJy/crypt.png", 10472)
                    },					
                    ...
                    [3] = new List<BlockInfo>
                    {
                        ...
                        new("Space", "https://i.ibb.co/tMjJh8Nf/space.png", 10430)
                    }
                },
                Version = Version
            };
                ...
                case "choose":
                    {
                        ...
                        ImageLayers(player, index, skinIndex);
						// assets moved to AssetScene-props.other
