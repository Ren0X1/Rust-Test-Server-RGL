...
namespace Oxide.Plugins
{
    ...
    public class GuiaRust : RustPlugin
    {
        ...
        static readonly List<Entrada> Comandos = new List<Entrada>
        {
            ...
            new Entrada { Titulo = "Craftear en el inventario", Etiqueta = "/materiales",
                Texto = "El boton <color=#ff0>Craft</color> lo decide tu cliente mirando lo que llevas encima: sin materiales sale gris y el servidor ni se entera.\n<color=#ff0>/materiales</color> (o /mats) te llena la mochila con recursos y componentes. Con eso el boton se enciende, y lo que gastes <color=#7f7>se te devuelve</color>: sale gratis y al momento.\n<color=#ff0>/limpiar</color> para vaciarla luego." },
            new Entrada { Titulo = "Craftear sin materiales", Etiqueta = "/craftear",
                Texto = "<color=#ff0>/craftear &lt;item&gt; [cantidad]</color> — lo hace el servidor directamente, sin pasar por el boton ni necesitar recursos.\nEjemplo: <color=#ff0>/craftear rifle.ak 2</color>.\nVale tambien un trozo del nombre: /craftear thompson." },
